import {
  ...
  export const locationsTab = [
    { id: 1, label: 'Co-living', icon: <GrGroup size={24} color={"primary"}/> },
    { id: 2, label: 'Managed Apartments', icon: <MdOutlineApartment size={24} /> },
    { id: 3, label: 'Students Housing', icon: <MdHouseSiding size={24} /> },
    { id: 4, label: 'Short Period', icon: <AiOutlineFieldTime size={24} /> },
  ];
